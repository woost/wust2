...
object UnreadComponents {
  ...
  def activityButtons(nodeId: NodeId, modifiers: VDomModifier = VDomModifier.empty)(implicit ctx: Ctx.Owner): EmitterBuilder[View.System, VDomModifier] = EmitterBuilder.ofModifier { sink =>
