...
object NotesView {
    ...
    div(
      ...
      div(
        ...
        Rx {
          ...
          childNodes.map { node =>
            renderNote(focusState, traverseState, node)
          }
        },
  ...
  private def renderNote(focusState: FocusState, traverseState: TraverseState, node: Node)(implicit ctx: Ctx.Owner): VNode = {
