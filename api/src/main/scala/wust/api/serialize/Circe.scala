...
object Circe extends wust.ids.serialize.Circe {
  ...
  implicitly[Decoder[NodeAccess]]
  implicitly[Decoder[UserId]]
  implicitly[Decoder[NodeId]]
  implicitly[Decoder[NodeData]]
  implicitly[Decoder[NodeData.Type]]
  implicitly[Decoder[NodeMeta]]
  implicitly[Decoder[NodeData.Content]]
  implicitly[Decoder[DateTimeMilli]]
  implicitly[Decoder[DateMilli]]
  implicitly[Decoder[DurationMilli]]
  implicitly[Decoder[NodeTypeSelection.Data]]
  implicitly[Decoder[NodeTypeSelection]]
  ...
  implicit val ConnectionDecoder8: Decoder[Edge.Mention] = deriveDecoder[Edge.Mention]
  implicit val ConnectionEncoder8: Encoder[Edge.Mention] = deriveEncoder[Edge.Mention]
