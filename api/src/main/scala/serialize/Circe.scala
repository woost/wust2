...
object Circe extends wust.ids.serialize.Circe {
  ...
  implicit val ConnectionDecoder01: Decoder[Edge.NodeUserEdge] = deriveDecoder[Edge.NodeUserEdge]
  implicit val ConnectionEncoder01: Encoder[Edge.NodeUserEdge] = deriveEncoder[Edge.NodeUserEdge]
  implicit val ConnectionDecoder02: Decoder[Edge.ContentEdge] = deriveDecoder[Edge.ContentEdge]
  implicit val ConnectionEncoder02: Encoder[Edge.ContentEdge] = deriveEncoder[Edge.ContentEdge]
