...
create function can_access_node_expecting_cache_table(userid uuid, nodeid uuid) returns boolean as $$
begin
...
begin
    ...
    result := can_access_node_expecting_cache_table(userid, nodeid);
