...
-- single node
SELECT cmp_ok(node_can_access(node_to_uuid('C1'), user_to_uuid('A1'), 'readwrite'::accesslevel), '=', false);
-- array of nodes, returning conflicting nodes
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C1')], user_to_uuid('A1'), 'readwrite'::accesslevel)), '=', array[node_to_uuid('C1')]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C2'), user_to_uuid('A2'), 'readwrite'::accesslevel), '=', false);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C2')], user_to_uuid('A2'), 'readwrite'::accesslevel)), '=', array[node_to_uuid('C2')]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C3'), user_to_uuid('A3'), 'readwrite'::accesslevel), '=', false);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C3')], user_to_uuid('A3'), 'readwrite'::accesslevel)), '=', array[node_to_uuid('C3')]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C5'), user_to_uuid('A5'), 'readwrite'::accesslevel), '=', true);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C5')], user_to_uuid('A5'), 'readwrite'::accesslevel)), '=', array[]::uuid[]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C6'), user_to_uuid('A6'), 'readwrite'::accesslevel), '=', true);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C6')], user_to_uuid('A6'), 'readwrite'::accesslevel)), '=', array[]::uuid[]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C7'), user_to_uuid('A7'), 'readwrite'::accesslevel), '=', false);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C7')], user_to_uuid('A7'), 'readwrite'::accesslevel)), '=', array[node_to_uuid('C7')]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C8'), user_to_uuid('A8'), 'readwrite'::accesslevel), '=', false);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C8')], user_to_uuid('A8'), 'readwrite'::accesslevel)), '=', array[node_to_uuid('C8')]::uuid[]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C8'), user_to_uuid('A8'), 'readwrite'::accesslevel), '=', false);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C8')], user_to_uuid('A8'), 'readwrite'::accesslevel)), '=', array[node_to_uuid('C8')]::uuid[]);
SELECT cmp_ok(node_can_access(node_to_uuid('C8'), user_to_uuid('A8'), 'read'::accesslevel), '=', false);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C8')], user_to_uuid('A8'), 'read'::accesslevel)), '=', array[node_to_uuid('C8')]::uuid[]);
...
SELECT cmp_ok(node_can_access(node_to_uuid('C6'), user_to_uuid('A6'), 'readwrite'::accesslevel), '=', false);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C6')], user_to_uuid('A6'), 'readwrite'::accesslevel)), '=', array[node_to_uuid('C6')]::uuid[]);
SELECT cmp_ok(node_can_access(node_to_uuid('C6'), user_to_uuid('A6'), 'read'::accesslevel), '=', true);
SELECT cmp_ok(array(select * from inaccessible_nodes(array[node_to_uuid('C6')], user_to_uuid('A6'), 'read'::accesslevel)), '=', array[]::uuid[]);
