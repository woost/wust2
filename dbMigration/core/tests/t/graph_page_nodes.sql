...
-- multiple page_childs / multiple traversal starts
select cleanup();
select usernode('0A');
select node('01', 'readwrite');
select node('11', 'readwrite'); select child('11', '01');
...
-- inaccessible direct child of child
select cleanup();
select usernode('0A');
select node('01', 'readwrite');
select node('11', 'readwrite'); select child('01', '11');
...
-- accessible accesslevel of child is determined by child
select cleanup();
select usernode('0A');
...
-- inaccessible accesslevel of child is determined by child
select cleanup();
select usernode('0A');
select node('01', null); -- inherited
select node('11', null); select child('01', '11');
