...
lazy val frontend = project
  ...
  .settings(
    ...
    scalaJSOptimizerOptions in fastOptJS ~= { _.withDisableOptimizer(true) }, // disable optimizations for better debugging experience, TODO: issue with fullOpt: https://github.com/scala-js/scala-js/issues/2786
