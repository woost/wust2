...
lazy val root = project.in(file("."))
  ...
  .settings(
    publish := {},
    publishLocal := {},
    unidocProjectFilter in (ScalaUnidoc, unidoc) := inAnyProject -- inProjects(apiJS, sdkJS, idsJS, graphJS, utilJS),
    siteSubdirName in ScalaUnidoc := "latest/api",
    addMappingsToSiteDir(mappings in (ScalaUnidoc, packageDoc), siteSubdirName in ScalaUnidoc),
    gitRemoteRepo := "git@github.com:Woost/wust2.git",
...
lazy val utilJS = util.js.settings(name := "wust-utilJS")
lazy val utilJVM = util.jvm.settings(name := "wust-utilJVM")
...
lazy val sdkJS = sdk.js.settings(name := "wust-sdkJS")
lazy val sdkJVM = sdk.jvm.settings(name := "wust-sdkJVM")
...
lazy val idsJS = ids.js.settings(name := "wust-idsJS")
lazy val idsJVM = ids.jvm.settings(name := "wust-sdkJS")
...
lazy val graphJS = graph.js.settings(name := "wust-graphJS")
lazy val graphJVM = graph.jvm.settings(name := "wust-graphJVM")
...
lazy val apiJS = api.js.settings(name := "wust-apiJS")
lazy val apiJVM = api.jvm.settings(name := "wust-apiJVM")
