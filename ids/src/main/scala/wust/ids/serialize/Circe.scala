...
trait Circe {
  ...
  implicit val connectionContentDecoder11: Decoder[EdgeData.Notify] = deriveDecoder[EdgeData.Notify]
  implicit val connectionContentEncoder11: Encoder[EdgeData.Notify] = deriveEncoder[EdgeData.Notify]
