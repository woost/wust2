...
trait Circe {
  ...
  implicit val connectionContentDecoder11: Decoder[EdgeData.Reminder] = deriveDecoder[EdgeData.Reminder]
  implicit val connectionContentEncoder11: Encoder[EdgeData.Reminder] = deriveEncoder[EdgeData.Reminder]
