...
trait Circe {
  ...
  implicit val connectionContentDecoder10: Decoder[EdgeData.Joined] = deriveDecoder[EdgeData.Joined]
  implicit val connectionContentEncoder10: Encoder[EdgeData.Joined] = deriveEncoder[EdgeData.Joined]
