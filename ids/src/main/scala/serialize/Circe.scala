...
trait Circe {
  ...
  implicit val connectionContentDecoder5: Decoder[EdgeData.Before] = deriveDecoder[EdgeData.Before]
  implicit val connectionContentEncoder5: Encoder[EdgeData.Before] = deriveEncoder[EdgeData.Before]
