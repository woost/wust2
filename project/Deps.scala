...
object Deps {
  ...
  val vectory = dep("com.github.fdietze" % "vectory" % "0e8b35a")
  ...
  val outwatch = dep("com.github.cornerman" % "outwatch" % "31e7d15c")
  ...
  val flatland = dep("com.github.fdietze.flatland" %%% "flatland" % "962dbb6")
