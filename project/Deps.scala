...
object Deps {
  ...
  val vectory = dep("com.github.fdietze" % "vectory" % "1189c49")
  ...
  val outwatch = dep("com.github.outwatch" % "outwatch" % "f41b8a3d")
  // val outwatch = dep("io.github.outwatch" %%% "outwatch" % "0.11.1-SNAPSHOT")
  val bench = dep("com.github.fdietze.bench" %%% "bench" % "8fd636f")
  ...
  val flatland = dep("com.github.fdietze.flatland" %%% "flatland" % "557b47d")
